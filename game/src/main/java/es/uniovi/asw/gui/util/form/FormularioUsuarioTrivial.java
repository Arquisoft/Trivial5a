...
public class FormularioUsuarioTrivial extends Form {
	...
	public String[] formularioUsuarioTrivial() {
		 ...
		 * 
		 * cliente[0] = form.getField("Dni").getString(); cliente[1] =
		 * form.getField("Nombre").getString(); cliente[2] =
		 * form.getField("Apellido").getString(); cliente[3] =
		 * form.getField("Ciudad").getString(); cliente[4] =
		 * form.getField("Calle").getString(); cliente[5] =
		 * form.getField("Codigo Postal").getString(); cliente[6] =
		 * form.getField("Telefono").getString(); cliente[7] =
		 * form.getField("Email").getString();
		 * 
		 * return cliente;
		 */
		return null;
